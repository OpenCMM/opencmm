...
def test_identify_close_edge_process_2():
    ...
    # save_csv("tests/fixtures/csv/process_2/measured_edges.csv", measured_edges)
    # edge_data = find.get_edge_data(model_id, MYSQL_CONFIG)
    # save_csv("tests/fixtures/csv/process_2/edge_data.csv", edge_data)
...
def test_identify_close_edge_process_5():
    ...
    # model_id = 2
    # measured_edges = find.find_edges(process_id, MYSQL_CONFIG)
    # save_csv("tests/fixtures/csv/process_5/measured_edges.csv", measured_edges)
    # edge_data = find.get_edge_data(model_id, MYSQL_CONFIG)
    # save_csv("tests/fixtures/csv/process_5/edge_data.csv", edge_data)
